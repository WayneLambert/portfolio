...
class TestProfile:
    ...
    def test_multi_profile_saves(self):
        ...
        assert User.objects.count() == 11, 'Should have 11 objects in the database'
    ...
    def test_can_delete_profile(self):
        ...
        users[4].delete()
        assert User.objects.count() == 10, 'Should have 9 objects remaining in the database'
        ...
        assert User.objects.count() == 10, 'Should still equal 10'
    ...
    def test_full_name(self, fixed_user):
        ...
        assert profile.full_name == 'Wayne Lambert', \
            'Should be first and last name concatenated'
