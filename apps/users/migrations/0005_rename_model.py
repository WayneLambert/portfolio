    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('challenge_token_generated', models.CharField(default=django_otp.util.random_hex, max_length=40, validators=[apps.users.utils.token_validator])),
