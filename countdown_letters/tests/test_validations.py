...
@pytest.mark.slow(
    reason='Processing makes 2 calls to the Oxford Online API')
...
def test_is_eligible_answer(given_answers_list, letters: str = 'SVEODRETR'):
    """
    Asserts that given a list fixture containing 8 words, the first 4 words pass the
    eligibility tests since all of their letters are present and can be used from the
    game letters. Similarly, the last 4 items in the list fixture should fail since
    their letters are not present within the game's letters selection.
    """
